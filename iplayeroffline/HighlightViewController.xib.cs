...
{
	partial class HighlightViewController : UITableViewController
	{
		public HighlightViewController (IntPtr handle) : base(handle)
		{
		}
		...
		*/
		...
		{
			HighlightViewController controller;

			List<RemoteProgram> programs = new List<RemoteProgram>();
			public DataSource (HighlightViewController controller)
			{
				this.controller = controller;
			}
			
			public void LoadPrograms(string sourceUrl) 
			{
				programs = RemoteProgramHelper.GetRemoteProgramList(sourceUrl, false);
				UIApplication.SharedApplication.NetworkActivityIndicatorVisible = true;
